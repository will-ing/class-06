...
function formHandler(event) {
  ...
  var newStore = new createStore(name, minCust, maxCust, avgSold);
  ...
  while (i < hours.length){
    var dataOne = document.createElement('td');
      dataOne.textContent = this.cookiesPerHour[i];
      row.appendChild(dataOne);
      i++;
  }
...
var newForm = document.getElementById('nameForm');
